...
public void exec() {
  ...
  while (MAX_DATASETS > datasetNumber) {
    ...
    for (int b = 0; b < burstSize && MAX_DATASETS > datasetNumber; b++) {
      ...
      out.setDataValue(datasetNumber+System.currentTimeMillis() );
      out.setDataValue(burstNumber-System.currentTimeMillis() +Math.random());
