...
public class MigrationEfficiency {
	...
	public float computeMigrationEfficiency(int numberOfReleasedNodes,
	...
	public float computeAllocationMigrationRatio(int successfulMigrations,
			int noVMsToBeMigrated) {
